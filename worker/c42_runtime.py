...
out={
 ...
 "ROLE":farm.get("domain","knowledge-graph-vector-index"),
 ...
 "PROVENANCE":{"repository":"dmaillot95-ui/cerebron-farm-66-knowledge-graph-vector-index","generated_at":datetime.datetime.now(datetime.timezone.utc).isoformat()},
